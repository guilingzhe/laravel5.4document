(function(a) {
    a.jBox = function(b, c) {
        ...
        j.push('<a class="jbox-close" title="' + a.jBox.languageDefaults.close + '" onmouseover="$(this).addClass(\'jbox-close-hover\');" onmouseout="$(this).removeClass(\'jbox-close-hover\');" style="position:absolute; display:block; cursor:pointer; top:11px; right:20px; width:20px; height:20px;' + (c.showClose ? '': 'display:none;') + '"></a>');
        if (g) {
            j.push('<div class="jbox-title-panel" style="height:40px;">');
            j.push('<div class="jbox-title' + (c.showIcon == true ? ' jbox-title-icon': (c.showIcon == false ? '': ' ' + c.showIcon)) + '" style="float:left; width:80%; line-height:40px; padding-left:' + 0x12 + 'px;overflow:hidden;text-overflow:ellipsis;word-break:break-all;font-size:16px;color:#555;">' + (c.title == '' ? '&nbsp;': c.title) + '</div>');
            j.push('</div>')
        };
    ...
    a.jBox.prompt = function(b, c, d, e) {
        ...
        h.push('<span class="jbox-icon jbox-icon-' + e.icon + '" style="position:absolute; top:' + (f + e.border+18) + 'px;left:' + (0xa + e.border) + 'px; width:35px; height:36px;"></span>');
        h.push(e.content);
        h.push('</div>');
        e.content = h.join('');
        a.jBox(e.content, e)
